  ...
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">patryk77.k@gmail.com</span>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+49 176 34535037</span>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Patryk Kardach</span>
        ...
        <div className="contact__content">
          <h3 className="contact__title">Write me direct message</h3>
